...
+(RKResponseDescriptor *)postDeviceResponseDescriptorWithMapping:(RKObjectMapping *)mapping {
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:mapping                                                                                            method:RKRequestMethodPOST                                                                                       pathPattern:API_USERS_DEVICES                                                                                          keyPath:nil                                                                                       statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
