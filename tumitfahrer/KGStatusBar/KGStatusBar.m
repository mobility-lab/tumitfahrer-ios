...
+ (void)showSuccessWithStatus:(NSString*)status
{
    ...
    [KGStatusBar performSelector:@selector(dismiss) withObject:self afterDelay:1.0];
}
...
- (UIView *)topBar {
    if(!topBar) {
        topBar = [[UIView alloc] initWithFrame:CGRectMake(0.f, 0.f, [self rotatedSize].width, 70.0f)];
